 ...
 */
export function createYInv(src, invId, invType, slotCount, maxCoordX, maxCoordY) {
    src.set('invId', invId);
...
export function copyYInv(other, dst = undefined) {
    if (!dst) {
        dst = createYInv(other.__src, uuid(), other.type, other.length, other.width, other.height);
    }
