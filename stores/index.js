 ...
 * @returns {ViewId}
 */
export function createInvViewInStore(store, coordX, coordY, viewWidth, viewHeight, viewType, invType, slotCount, invWidth, invHeight, usage, topics) {
    let viewId = uuid();
    let invId = uuid();
    createViewInStore(store, viewId, invId, coordX, coordY, topics, usage, viewType, viewWidth, viewHeight);
